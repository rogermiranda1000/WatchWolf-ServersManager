...
docker run -it --rm -v "$base_path":"/compile" -v "$local_maven_repos_path":/root/.m2 maven:3.8.3-openjdk-17 mvn compile assembly:single -Dmaven.test.skip=true --file '/compile'
